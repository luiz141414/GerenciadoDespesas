...
namespace GerenciadorDespesas.Controllers
{
    public class DespesasController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoDespesasId"] = new SelectList(_context.TipoDespesas, "TipoDespesaId", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("DespesaId,MesId,TipoDespesasId,Valor")] Despesas despesas)
        {
            ...
            ViewData["TipoDespesasId"] = new SelectList(_context.TipoDespesas, "TipoDespesaId", "Nome", despesas.TipoDespesasId);
